...
​		[讯飞开放平台](https://www.xfyun.cn/) (https://www.xfyun.cn/)  提供大量的AI能力，并提供了java和python3等多种语言的调用Demo，下载即用，方便快捷，瞬间便可实现诸如翻译、转写等人工智能能力！官方Demo虽好，但是它并未提供C++版本，为了使用更加方便，本文针对“机器翻译”能力用C++写了一个调用的WebAPI的Demo,分享出来与大家交流学习。
